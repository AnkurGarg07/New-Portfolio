...
const Footer = () => {
    return (
      <>
          <footer className=" relative z-10 rounded-md bg-primaryDark flex flex-col items-center justify-center w-full py-20 max-sm:py-10" id="contact">
              <div className="flex flex-col items-center w-[50%] max-sm:w-[80%]">
                  <h1 className="font-bold text-4xl md:text-5xl text-center text-textPrimary">
                      Ready to take <span className="text-textSecondary">your</span> digital
                  ...
                  <a href="mailto:ankurgarg89p@gmail.com" className="w-full md:w-60 pointer-events-auto max-sm:w-[80%] ">
                      <MagicButton
